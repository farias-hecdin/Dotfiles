...
vim.opt.scrolloff = 3 -- determines the number of context lines you would like to see above and below the cursor.
...
opt.showtabline = 1 -- show tabline (2 default)
opt.sidescrolloff = 8 -- columns of context
opt.signcolumn = "yes" -- show sign column so that text doesn't shift
opt.smartcase = true -- if you include mixed case in your search, assumes you want case-sensitive
opt.smartindent = true -- make indenting smarter again
opt.spell = false
--opt.spelllang = "es" -- importante para editar escritos en español
