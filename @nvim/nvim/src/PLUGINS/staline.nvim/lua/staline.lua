...
local h = require("staline.widgets")
...
M.get_statusline = function(status, x)
  ...
  M.sections["clock"]            = " " .. h.app_clock() .. " "
  M.sections["counter"]          = " " .. h.app_counter() .. " "
  M.sections["lazy"]             = " " .. h.app_lazy() .. " "
