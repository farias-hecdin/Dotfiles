...
# CAMBIADO: Adaptado para Bash
alias balias="$EDITOR ~/.bash_aliases" # (O donde guardes tus alias ahora)
alias bconfig="$EDITOR ~/.bashrc"      # Reemplaza a zconfig
